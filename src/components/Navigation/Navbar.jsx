...
import Person from "/images/my image.jpg";

const Navbar = () => {
  return (
    <div>
      <div className="flex bg-card-bg-100 pt-3 pb-3">
        <div className="columns-2 mt-2 ml-4 ">
          <Link>
            <button className="bg-secondary-bg-200 rounded-md pl-2 pr-2 pt-1 pb-1">
          ...
          <span className="ml-2">
            <input
              type="search"
              placeholder="Search"
              className="p-1 bg-icon-bg-400 rounded-md"
            />
          </span>
        </div>
        ...
        <div className="flex columns-2 ml-28 pt-2">
          <button className="bg-icon-bg-400 pl-2 pr-2 h-8 rounded-md ">
            <i class="bi bi-chat-square-text"></i>
          </button>

          <button className="ml-3 bg-icon-bg-400 pl-2 pr-2 h-8 rounded-md">
          ...
          <span className="ml-2  bg-icon-bg-400">
